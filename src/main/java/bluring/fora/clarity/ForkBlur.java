...
public class ForkBlur extends RecursiveAction {
	...
	protected void computeDirectly() {
		...
		for (int index = mStart; index < mLength + mStart; index++) {
	...
	public static void main(String[] args) throws IOException {
		String srcName = "C:\\Users\\svladimirov\\Documents\\Untitled_WOW.png";
		File srcFile = new File(srcName);
		BufferedImage image = ImageIO.read(srcFile);

		System.out.println("Source image: " + srcName);

		BufferedImage blurredImage = blur(blur(blur(image)));

		String dstName = "C:\\Users\\svladimirov\\Documents\\Untitled_WOW_WOW.png";
